...
import { Send, Bot, User, Loader2, Languages, Lock, CheckCircle2, X, MessageCircle } from "lucide-react";
import "./index.css";

/**
 * Amer Smart Assistant - Floating Widget Version
 * ----------------------------------------------
 * - Floating action button that opens/closes the chat
 * - Compact widget design for embedding on any website
 * - All original features preserved (multilingual, intent detection, etc.)
